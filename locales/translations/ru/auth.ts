...
export const registration = {
  ...
  error: {
    errorButton: 'Регистрация',
    errorText:
      'Ваша почта не подтверждена, ввиду неизвестной ошибки. Попробуйте зарегистрироваться снова.',
    notConfirmedButton: 'Попробовать снова',
    notConfirmedText:
      'Ваша почта не подтверждена, ввиду не валидности кода. Попробуйте снова отправить ссылку для подтверждения.',
    title: 'Упс!!!',
  },
  expired: {
