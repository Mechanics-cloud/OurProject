...
import * as filledIcons from '../../../assets/icons'
...
//       <div key={name} className="inline-flex items-center flex-none w-1/5 mr-5 mb-5">
//         <Icon className="w-8 h-8 mr-2.5"/> {name}
//       </div>
//     ))}
//   </div>
// );
